...
# Keep public contracts stable for Godot bindings and JSON persistence, while renaming private
# implementation details. String hiding and method-body rewriting stay disabled to avoid adding
# permanent runtime work to a public build.
#
# `nameof(...)` becomes a string literal in IL. Godot APIs such as CallDeferred can use that
# string for dynamic lookup, so preserve matching members automatically.
...
Write-Host "Obfuscating Desktop Buddy managed implementation names..."
