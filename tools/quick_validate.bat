...
echo [4/39] Checking laboratory controls...
...
echo [5/39] Checking grab and throw...
...
echo [6/39] Checking grab hang orientation...
...
echo [7/39] Checking grab swing pendulum...
...
echo [8/39] Checking room resize and zoom...
...
echo [9/39] Running lab spawn/settle journey...
...
echo [10/39] Running grab-throw journey...
...
echo [11/39] Checking dual-profile composition...
...
echo [12/39] Checking M4 object catch/hold...
...
echo [13/39] Checking M4 behavior priority ladder...
...
echo [14/39] Checking M4 hidden lifecycle accrual...
...
echo [15/39] Running M4 care/persistence relaunch journey...
...
echo [16/39] Checking clean-catch laugh and fun interest...
...
echo [17/39] Checking M5 Baseball purchase and pullback launch...
...
echo [18/39] Checking cornered ground pickup...
...
echo [19/39] Checking the FR-014 loose-object budget...
...
echo [20/39] Checking the M5 Meal consume and cooldown...
...
echo [21/39] Running the M5 Meal journey...
...
echo [22/39] Checking the M5 Baseball Bat swing...
...
echo [23/39] Running the M5 Baseball Bat journey...
...
echo [24/39] Running the M5 Home-Run Bat journey...
...
echo [25/39] Checking the M5 Pistol cadence, reload, and shot...
...
echo [26/39] Running the M5 Pistol journey...
...
echo [27/39] Checking the M5 Grenade pin, fuse, and blast...
...
echo [28/39] Running the M5 Grenade journey...
...
echo [29/39] Checking the M5 Fire Sprayer stream and Burning...
...
echo [30/39] Running the M5 Fire Sprayer journey...
...
echo [31/39] Checking the M5 Soccer Ball bounce and the Drink's care rules...
...
echo [32/39] Running the M5 Soccer Ball journey...
...
echo [33/39] Running the M5 Drink journey...
...
echo [34/39] Checking the M5 Shotgun spread, dedup, and shell eject...
...
echo [35/39] Running the M5 Shotgun journey...
...
echo [36/39] Checking the M5 Repair Kit application and clears...
"%GODOT_HEADLESS%" --headless --fixed-fps 120 --path . --rendering-driver opengl3 --log-file "%PROJECT_ROOT%\.artifacts\quickepair_kit.log" -- --scenario=repair_kit --seed=1 --artifacts=.artifacts\quickepair_kit
if errorlevel 1 goto :failed

echo [37/39] Running the M5 Repair Kit journey...
...
echo [38/39] Checking Power Grab against Normal Grab...
...
echo [39/39] Running the M5 Power Grab journey...
