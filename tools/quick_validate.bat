...
echo [4/23] Checking laboratory controls...
...
echo [5/23] Checking grab and throw...
...
echo [6/23] Checking grab hang orientation...
...
echo [7/23] Checking grab swing pendulum...
...
echo [8/23] Checking room resize and zoom...
...
echo [9/23] Running lab spawn/settle journey...
...
echo [10/23] Running grab-throw journey...
...
echo [11/23] Checking dual-profile composition...
...
echo [12/23] Checking M4 object catch/hold...
...
echo [13/23] Checking M4 behavior priority ladder...
...
echo [14/23] Checking M4 hidden lifecycle accrual...
...
echo [15/23] Running M4 care/persistence relaunch journey...
...
echo [16/23] Checking clean-catch laugh and fun interest...
...
echo [17/23] Checking M5 Baseball purchase and pullback launch...
...
echo [18/23] Checking cornered ground pickup...
...
echo [19/23] Checking the FR-014 loose-object budget...
...
echo [20/23] Checking the M5 Meal consume and cooldown...
...
echo [21/23] Running the M5 Meal journey...
...
echo [22/23] Checking the M5 Baseball Bat swing...
"%GODOT_HEADLESS%" --headless --fixed-fps 120 --path . --rendering-driver opengl3 --log-file "%PROJECT_ROOT%\.artifacts\quickat_swing.log" -- --scenario=bat_swing --seed=1 --artifacts=.artifacts\quickat_swing
if errorlevel 1 goto :failed

echo [23/23] Running the M5 Baseball Bat journey...
