...
| 7 | `select_paint_brush` | Pick up the Brush — it is the one you will use most. |
| 8 | `select_paint_color` | Now pick any colour that takes your fancy. |
| 9 | `paint_buddy` | Go on, paint something across Buddy's torso. |
| 10 | `save_paint_buddy` | Happy with it? Save the character to keep your work. |
...
| 25 | `exit_buddy_studio` | That is Buddy Studio. Exit when you are ready. |
...
| 28 | `drag_work_companion` | Hold the left mouse button on Buddy, on the computer, or on the blue bar, then move the mouse to drag the companion wherever you want it. |
...
All ids are prefixed `demo.onboarding.` in `TutorialStepIds`.
