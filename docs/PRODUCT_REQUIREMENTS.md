...
10. **FR-008.10:** WHEN a Meal, Drink, or Repair Kit is cancelled, dropped without successful use, or otherwise fails to be consumed/used THEN it SHALL neither fill the hunger bar nor begin any reuse cooldown; only successful consumption/use SHALL do either.
