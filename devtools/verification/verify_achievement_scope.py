...
# Unique production sentinels spanning both the game and domain assemblies. Search UTF-8 and
# UTF-16LE because metadata/string representation is an implementation detail of the compiler.
SENTINELS = (
...
def main() -> int:
    ...
    if args.expect == "excluded":
        ...
        if leaked:
            ...
            return 1
        print("achievement scope: excluded; no first-party implementation sentinels found")
        return 0
    ...
    print("achievement scope: included; all first-party implementation sentinels found")
    return 0
