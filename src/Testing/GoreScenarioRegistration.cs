...
/// <summary>Registers the Gore Mode scenario without expanding the legacy central registry.</summary>
internal static class GoreScenarioRegistration
{
    [ModuleInitializer]
    internal static void Register()
    {
        ...
        factories["gore_mode"] = () => new GoreModeScenario();
    }
}
