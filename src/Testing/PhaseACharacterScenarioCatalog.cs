...
public static class PhaseACharacterScenarioCatalog
{
    private static readonly Dictionary<string, Func<IScenario>> Factories = new(StringComparer.Ordinal)
    {
        ...
        ["reward_popup_demo"] = () => new RewardPopupScenario(),
        ["settings_hotkey_capture"] = () => new SettingsHotkeyCaptureScenario(),
        ["win98_catalog_grid_update"] = () => new Win98CatalogGridUpdateScenario(),
    };
