...
public enum BuddyCosmeticVisualKind { None, HairShortSweep, NoseButton, EarsRoundTabs, WorkClassicGlasses, HeadwearSoftCap, TopUtilityBib, ShoesSoftSteps, GeneratedAsset }
