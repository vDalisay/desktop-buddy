...
public sealed class CharacterFeatureCatalog
{
    ...
    private static IEnumerable<CosmeticDefinition> CreateShippedDefinitions()
    {
        ...
        yield return Definition(CharacterFeatureIds.HeadwearSoftCap, CharacterFeatureSlot.Headwear, 10, false, CosmeticTransformPolicy.MoveAndUniformScale, CharacterFeatureIds.HeadwearNone, Rgba32.Parse("#C95B63"), hidesHair: true, ownershipContentId: ContentIds.CosmeticHeadwearSoftCap);
        yield return Definition(CharacterFeatureIds.HeadwearKnitBeanie, CharacterFeatureSlot.Headwear, 20, false, CosmeticTransformPolicy.MoveAndUniformScale, CharacterFeatureIds.HeadwearNone, Rgba32.Parse("#C95B63"), hidesHair: true, ownershipContentId: ContentIds.CosmeticHeadwearKnitBeanie);
        yield return Definition(CharacterFeatureIds.HeadwearWideBrim, CharacterFeatureSlot.Headwear, 30, false, CosmeticTransformPolicy.MoveAndUniformScale, CharacterFeatureIds.HeadwearNone, Rgba32.Parse("#C95B63"), hidesHair: true, ownershipContentId: ContentIds.CosmeticHeadwearWideBrim);
