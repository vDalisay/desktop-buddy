...
{
    public int SchemaVersion { get; set; } = CharacterDocumentPolicy.CurrentSchemaVersion;
    public Guid Id { get; set; }
    public string DisplayName { get; set; } = string.Empty;
    public CharacterPartColors PartColors { get; set; } = CharacterPartColors.BuiltIn;
    public CharacterFeatureSet Features { get; set; } = CharacterFeatureSet.BuiltIn;
    public CharacterPaintManifest Paint { get; set; } = CharacterPaintManifest.Empty;
...
public sealed record CharacterPartColors
{
    ...
    public Rgba32 Head { get; set; } = BuiltInHead;
    public Rgba32 Torso { get; set; } = BuiltInTorso;
    public Rgba32 LeftHand { get; set; } = BuiltInHand;
    public Rgba32 RightHand { get; set; } = BuiltInHand;
    public Rgba32 LeftFoot { get; set; } = BuiltInFoot;
    public Rgba32 RightFoot { get; set; } = BuiltInFoot;
}
...
public sealed record CharacterFeatureSet
{
    ...
    public CharacterFeatureDocument Face { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.FaceClassicPlate);
    public CharacterFeatureDocument Hair { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.HairNone);
    public CharacterFeatureDocument Eyebrows { get => _eyebrows; init => _eyebrows = value; }
    public CharacterFeatureDocument Eyes { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.EyesSoftOval);
    public CharacterFeatureDocument Nose { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.NoseNone);
    public CharacterFeatureDocument Mouth { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.MouthRounded);
    public CharacterFeatureDocument Ears { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.EarsNone);
    public CharacterFeatureDocument Accessories { get => _accessories; init => _accessories = value; }
    public CharacterFeatureDocument Glasses { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.GlassesNone);
    public CharacterFeatureDocument Headwear { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.HeadwearNone);
    public CharacterFeatureDocument Tops { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.TopNone);
    public CharacterFeatureDocument Shoes { get; set; } = CharacterFeatureDocument.Create(CharacterFeatureIds.ShoesNone);
...
public sealed record CharacterFeatureDocument
{
    ...
    public Rgba32 Color { get; set; } = Rgba32.Parse("#183042");
    ...
    /// </summary>
    public Dictionary<string, Rgba32> Colors { get; set; } = new(StringComparer.Ordinal);
